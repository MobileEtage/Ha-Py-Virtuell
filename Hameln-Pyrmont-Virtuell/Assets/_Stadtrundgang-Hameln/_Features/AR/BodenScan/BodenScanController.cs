...
public class BodenScanController : MonoBehaviour
{
    ...
    public static BodenScanController instance;
    void Awake()
    {
        instance = this;
    }
    ...
    void LateUpdate()
    {
        if (SiteController.instance != null && SiteController.instance.currentSite != null && SiteController.instance.currentSite.siteID != "BodenScanSite") return;
    ...
    public IEnumerator InitCoroutine()
    {
        ...
        if (StationController.instance != null)
        {
            ...
            else { infoTitle.text = LanguageController.GetTranslation("Bodenscan"); }
            ...
            else { infoDescription.text = LanguageController.GetTranslation("Curabitur vulputate arcu odio, ac facilisis diam accumsan ut. Ut imperdiet et leo in vulputate. "); }
