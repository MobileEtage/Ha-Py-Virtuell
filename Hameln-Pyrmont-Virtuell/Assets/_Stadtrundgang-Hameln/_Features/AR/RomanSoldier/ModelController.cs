...
public class ModelController : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        if (SiteController.instance != null && SiteController.instance.currentSite != null && SiteController.instance.currentSite.siteID != "RomanSoldierSite") return;
    ...
    public IEnumerator InitCoroutine()
    {
        ...
        //LightController.instance.SetLightSettings("Soldier");
    ...
    public IEnumerator CommitCloseCoroutine()
    {
        ...
        //LightController.instance.SetLightSettings("Default");
        Reset();
