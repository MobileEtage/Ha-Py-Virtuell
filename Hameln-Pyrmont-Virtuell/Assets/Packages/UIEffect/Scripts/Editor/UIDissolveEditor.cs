...
namespace Coffee.UIExtensions.Editors
{
    ...
    {
	    SerializedProperty _invertEffectFactor;
        ...
        {
	        _invertEffectFactor = serializedObject.FindProperty("invertEffectFactor");
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Effect setting.
            //================
	        EditorGUILayout.PropertyField(_invertEffectFactor);
