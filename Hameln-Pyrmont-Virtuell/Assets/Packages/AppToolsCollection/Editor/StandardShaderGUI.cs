...
namespace UnityEditor
{
    internal class StandardShaderGUI : ShaderGUI
    {
        ...
        void DoNormalArea()
        {
            GUIContent bumpScaleGUIContentA = new GUIContent("Bump scale is not supported on mobile platforms");
            GUIContent bumpScaleGUIContentB = new GUIContent("Fix Now");
            ...
            if (bumpScale.floatValue != 1 && UnityEditorInternal.InternalEditorUtility.IsMobilePlatform(EditorUserBuildSettings.activeBuildTarget))
                ...
                */
                ...
                if (m_MaterialEditor.HelpBoxWithButton( bumpScaleGUIContentA, bumpScaleGUIContentB))
                {
